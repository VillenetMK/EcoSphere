...
-- CIMA may repeat manual pulses without the general 10/60-second pauses.
-- Its existing wet-soil grant remains the revocable authorization; every
-- other account keeps the original cooldowns. This does not request a pulse.
...
begin
  ...
  case v_action
    ...
    when 'pump' then
      ...
      -- Water, telemetry, manual mode and pulse duration remain mandatory.
