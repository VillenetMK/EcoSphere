...
test('la web ofrece instaladores oficiales para las tres plataformas', async () => {
  ...
  const expected = [
    ['Windows', 'EcoSphere-1.1.0-Windows-x64.msi', 'ic_windows.svg'],
    ['Linux', 'EcoSphere-1.1.0-Linux-amd64.deb', 'ic_linux.svg'],
    ['Android', 'EcoSphere-1.1.0-Android.apk', 'ic_android.svg'],
  ];
